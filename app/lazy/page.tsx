...
export default function LazyPage() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="mb-2 text-3xl font-bold text-black">Lazy Loading</h1>
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-black">1. React.lazy + Suspense</h2>
                ...
                <div className="rounded-lg border bg-white p-4 shadow-sm min-h-40 flex flex-col gap-3 justify-center">
                    {!showLazyExample && (
                        <button
            ...
            {/* dynamic() section */}
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-black">2. next/dynamic()</h2>
                <p className="text-gray-600 text-sm max-w-prose">
                ...
                <div className="rounded-lg border bg-white p-4 shadow-sm min-h-40 flex flex-col gap-3 justify-center">
                    {!showDynamicExample && (
                        <button
                            ...
                            className="self-start rounded bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-500"
                        >
            ...
            <section className="space-y-4">
                <h2 className="text-xl font-semibold text-black">Why both?</h2>
