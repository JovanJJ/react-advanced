...
function InnerClient({
    ...
    const [rawData, setRawData] = useState<Post[] | null>(serverData ?? null);

    // SWR path
    const { data: swrData, isLoading: swrLoading, isValidating } = useSWR<Post[]>(
...
export default function CachingDemoClient(props: { mode: "without" | "swr" | "cached"; swrKey: string; serverData?: Post[] | null }) {
