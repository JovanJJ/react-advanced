...
interface DeferredListTabProps {
  mode: Mode;
...
const HeavyList: FC<{ items: ReadonlyArray<{ id: number; name: string }> }> = ({ items }) => (
...
const DeferredListTab: FC<DeferredListTabProps> = ({ mode, items, isStale }) => {
  return (
    <div>
