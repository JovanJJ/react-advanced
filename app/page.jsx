  ...
  return (
    <div className="p-8">
      ...
      <ul className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <li>
          <Link href="/react-basics" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/deferred" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/transition" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/profiler" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/suspense" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/caching" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/lazy" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/websocket" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/optimistic" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/action-state" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/portals" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
        ...
        <li>
          <Link href="/compound" className="border border-gray-700 block rounded-lg bg-[#2A2A2A] p-6 shadow hover:shadow-md">
